...
(33, '2026_01_31_000000_create_tbl_news_table', 4),
);
...
-- Cau truc bang cho bang `tbl_news`
...
CREATE TABLE `tbl_news` (
  ...
  `news_category` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `news_summary` text COLLATE utf8mb4_unicode_ci,
...
--
-- AUTO_INCREMENT cho bang `tbl_news`
--
ALTER TABLE `tbl_news`
