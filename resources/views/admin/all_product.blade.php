      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="{{URL::to('/edit-product/'.$pro->product_id)}}" class="active styling-edit"><i class="fa fa-pencil-square-o text-success text-active"></i></a>
              <a onclick="return confirm('Xóa sản phẩm này?')" href="{{URL::to('/delete-product/'.$pro->product_id)}}" class="active styling-edit">
